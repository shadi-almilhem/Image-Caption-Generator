...
export async function POST(request: NextRequest) {
  ...
  - INCORPORATE ADDITIONAL INFORMATION: ${additionalInfo}, ONLY IF PROVIDED, OTHERWISE IGNORE.
  ...
  3. **INCLUDE ADDITIONAL INFO** (if available): ${additionalInfo}, If additional info is provided, incorporate it naturally; if not, proceed without it.
